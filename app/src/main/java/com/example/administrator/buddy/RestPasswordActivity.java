...
public class RestPasswordActivity extends BaseActivity {
        ...
        @Override public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    Toast.makeText(RestPasswordActivity.this, "" + msg.obj, Toast.LENGTH_SHORT)
                            .show();
                    break;
                case 8:
        ...
        findViewById(R.id.btn_register).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                if (acc.length() < 6 || acc.length() > 20) {
                    Toast.makeText(RestPasswordActivity.this, "输入账号不能少于6位数或者大于20位数",
                ...
                if (pas.length() < 6) {
                    Toast.makeText(RestPasswordActivity.this, "输入密码不能少于6位数或者大于20位数",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                if (ver.length() == 0) {
    ...
    public void reg() {
        mLoginPresenter.register(acctount.getText().toString(), password.getText().toString(),
                verifiaction.getText().toString(), false);
    }
